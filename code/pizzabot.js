...
const finalOrder = (name, quantity) => {
  ...
  document.getElementById("final-order").innerHTML = (`Great, I'll get started on your ${name} right away. It will cost you ${totalCost}kr. The pizzas will take ${cookingTime} minutes to prepare.`)
};
